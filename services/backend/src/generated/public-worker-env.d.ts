/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=wrangler-types.env --strict-vars=false --env-interface=PublicWorkerBindings src/generated/public-worker-env.d.ts` (hash: af7a940ba8096c8ad02dd36ac49a7f25)
// Runtime types generated with workerd@1.20260910.1 2026-07-29 nodejs_compat
interface __BaseEnv_PublicWorkerBindings {
	orderak_media: R2Bucket;
	orderak_db: D1Database;
	orderak_geo: D1Database;
	EMAIL: SendEmail;
	...
	STATIC_CITY_CATALOG_ENABLED: string;
	BUSINESS_TAXONOMY_ENABLED: string;
	MEDIA_RECLAIM_ENABLED: string;
	...
	LOCAL_JWT_VERIFICATION: string;
	FIREBASE_PROJECT_ID: string;
	BUYER_PRIVACY_PEPPER: string;
	FIREBASE_WEB_API_KEY: string;
	SENTRY_DSN: string;
	RATE_LIMITER: DurableObjectNamespace<import("../entrypoints/public-worker").RateLimiter>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../entrypoints/public-worker");
	...
	interface Env extends __BaseEnv_PublicWorkerBindings {}
}
interface PublicWorkerBindings extends __BaseEnv_PublicWorkerBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_ENVIRONMENT" | "BILLING_ENABLED" | "GOOGLE_PLAY_LIFECYCLE_ENABLED" | "AI_ASSISTANT_ENABLED" | "ENTITLEMENTS_ENABLED" | "AUTH_IDENTITY_ENABLED" | "ONBOARDING_ENABLED" | "PASSKEY_ENABLED" | "PHONE_CHANGE_ENABLED" | "STATIC_CITY_CATALOG_ENABLED" | "BUSINESS_TAXONOMY_ENABLED" | "MEDIA_RECLAIM_ENABLED" | "TURNSTILE_ENABLED" | "TURNSTILE_SITE_KEY" | "AI_MONTHLY_BUDGET_MICRO_USD" | "GOOGLE_PLAY_PACKAGE_NAME" | "ANDROID_APP_PACKAGE_NAME" | "PUBLIC_SITE_URL" | "WEBAUTHN_RP_ID" | "LOCAL_JWT_VERIFICATION" | "FIREBASE_PROJECT_ID" | "BUYER_PRIVACY_PEPPER" | "FIREBASE_WEB_API_KEY" | "SENTRY_DSN" | "DEEPSEEK_API_KEY" | "FORWARD_TO" | "PAYMENT_WEBHOOK_SECRET">> {}
}

...
export const APP_SCREEN_MANIFEST: AppScreenManifestItem[] = [
	...
	{ name: "Customer Details", description: "Customer profile, editable details and order history", android_route: "CustomerRoute", sort_order: 110, parent_route: "MainRoute#customers", surface: "customers", transitions: [{ to: "OrderDetailsRoute", trigger: "open order" }, { to: "MainRoute#customers", trigger: "back" }], states: ["loading", "content", "error"], offline_capable: true, entitlement_key: "customers_crm.editable_customer_profiles", feature_status: "implemented" },
	{ name: "Account", description: "Account surface: store, plan, devices, support", android_route: "MainRoute#account", sort_order: 120, parent_route: "MainRoute", surface: "account", transitions: [{ to: "StoreInfoRoute", trigger: "open entry" }, { to: "SellerProfileRoute", trigger: "open entry" }, { to: "CatalogLanguagesRoute", trigger: "open entry" }, { to: "SubscriptionRoute", trigger: "open entry" }, { to: "DevicesRoute", trigger: "open entry" }, { to: "SupportRoute", trigger: "open entry" }, { to: "AnnouncementsRoute", trigger: "open entry" }, { to: "AiAssistantRoute", trigger: "open entry" }, { to: "DeletionStatusRoute", trigger: "open entry" }, { to: "AuthRoute", trigger: "sign out" }], states: ["loading", "content"], offline_capable: true, entitlement_key: null, feature_status: "implemented" },
	{ name: "Store Information", description: "Store identity and public details", android_route: "StoreInfoRoute", sort_order: 130, parent_route: "MainRoute#account", surface: "store", transitions: [{ to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "error"], offline_capable: false, entitlement_key: null, feature_status: "implemented" },
	{ name: "Categories", description: "Product category management", android_route: "CategoriesRoute", sort_order: 140, parent_route: "MainRoute#account", surface: "store", transitions: [{ to: "MainRoute#products", trigger: "back" }, { to: "PaywallRoute", trigger: "add category", condition: "at plan limit" }], states: ["loading", "content", "empty", "error"], offline_capable: true, entitlement_key: "max_categories", feature_status: "implemented" },
	...
	{ name: "Support", description: "Seller support ticket list and creation", android_route: "SupportRoute", sort_order: 160, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "SupportTicketRoute", trigger: "open ticket" }, { to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "empty", "error"], offline_capable: false, entitlement_key: "support_service.in_app_support_tickets", feature_status: "implemented" },
	...
	{ name: "Announcements", description: "Targeted seller announcements", android_route: "AnnouncementsRoute", sort_order: 180, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "empty", "error"], offline_capable: false, entitlement_key: null, feature_status: "implemented" },
	{ name: "Catalog Languages", description: "Arabic and English product translation review", android_route: "CatalogLanguagesRoute", sort_order: 190, parent_route: "MainRoute#account", surface: "store", transitions: [{ to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "empty", "error"], offline_capable: false, entitlement_key: "language_localization.seller_translation_review", feature_status: "implemented" },
	{ name: "Devices", description: "Account device and session management", android_route: "DevicesRoute", sort_order: 200, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "MainRoute#account", trigger: "back" }, { to: "PaywallRoute", trigger: "add device", condition: "at plan limit" }], states: ["loading", "content", "error"], offline_capable: false, entitlement_key: "max_concurrent_devices", feature_status: "implemented" },
	{ name: "Seller Profile", description: "Seller personal details and email verification", android_route: "SellerProfileRoute", sort_order: 205, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "error"], offline_capable: false, entitlement_key: null, feature_status: "implemented" },
	{ name: "Deletion Status", description: "Account deletion request lifecycle", android_route: "DeletionStatusRoute", sort_order: 210, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "error"], offline_capable: false, entitlement_key: null, feature_status: "implemented" },
	{ name: "Subscription", description: "Subscription status and Play management guidance", android_route: "SubscriptionRoute", sort_order: 220, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "PlansRoute", trigger: "view plans" }, { to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "error"], offline_capable: true, entitlement_key: null, feature_status: "implemented" },
	{ name: "Plans", description: "Four-plan comparison built from the entitlement catalogue", android_route: "PlansRoute", sort_order: 225, parent_route: "SubscriptionRoute", surface: "account", transitions: [{ to: "SubscriptionRoute", trigger: "back" }], states: ["loading", "content", "error"], offline_capable: false, entitlement_key: null, feature_status: "implemented" },
	{ name: "Paywall", description: "Plan limit reached: the limit, the usage and what the next plan gives", android_route: "PaywallRoute", sort_order: 226, parent_route: "MainRoute", surface: "account", transitions: [{ to: "PlansRoute", trigger: "view plans" }, { to: "MainRoute", trigger: "dismiss", condition: "returns to the originating screen with input intact" }], states: ["content"], offline_capable: false, entitlement_key: null, feature_status: "implemented" },
	{ name: "AI Assistant", description: "Entitlement and deployment-gated seller assistant", android_route: "AiAssistantRoute", sort_order: 230, parent_route: "MainRoute#account", surface: "account", transitions: [{ to: "MainRoute#account", trigger: "back" }], states: ["loading", "content", "empty", "error"], offline_capable: false, entitlement_key: "max_ai_requests_per_month", feature_status: "implemented" },

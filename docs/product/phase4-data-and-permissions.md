...
| Catalog | Product/category text, price piasters, stock, images, translation provenance | Public catalog and order entry | Seller, public buyers, Cloudflare storage/processing | Source text controls; stale translation replacement; media deletion evidence | In scope |

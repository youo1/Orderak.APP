...
`currency` column added by migration `044`, live in both staging and
production as of 2026-09-23 — see
[database topology](../data/database.md#staging-and-production-schemas-are-in-sync). Item rows carry `product_name` as
